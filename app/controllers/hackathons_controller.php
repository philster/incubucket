...
/* SVN FILE: $Id: hackathons_controller.php 7 2013-02-17 15:00:00Z philster.work $ */

/**
 * Hackathons controller
 *  provide management of hackathons
 * @author		  philster
 * @version       $Revision: 1 $
 * @modifiedby    $LastChangedBy: philster.work $
 * @lastmodified  $Date: 2013-02-17 15:00:00 -0800 $
 */

class HackathonsController extends AppController {
    var $name               = 'Hackathons';
 ...
 */
    function index() {
        // setting title
        $this->set( 'title_for_layout', 'Hackathons' );
